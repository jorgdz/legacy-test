...
interface IDetailMatterMeshController
{
    /**
     * @OA\Get(
     *   path="/api/details-matter-mesh",
     ...
     *   operationId="addDetailMatterMesh",
     *   @OA\RequestBody(
     *     required=true,
     *     @OA\MediaType(
    ...
    /**
     * @OA\Get(
     *   path="/api/details-matter-mesh/{id}",
     *   tags={"Detalle Materia Malla"},
     *   security={
     *      {"api_key_security": {}},
     *   },
     ...
     *   operationId="getDetailMatterMesh",
     *   @OA\Parameter(
     *     name="user_profile_id",
     *     description="Id del perfil de usuario",
     *     in="query",
    ...
    /**
     * @OA\Put(
     *   path="/api/details-matter-mesh/{detailmattermesh}",
     *   tags={"Detalle Materia Malla"},
     *   security={
     *      {"api_key_security": {}},
     *   },
     ...
     *   operationId="updateDetailMatterMesh",
     *   @OA\Parameter(
     *     name="detailmattermesh",
     *     description="Id detalle materia malla",
     *     in="path",
     *     required=true,
     *     @OA\Schema(
     ...
     *   operationId="deleteDetailMatterMesh",
     *   @OA\Parameter(
     *     name="detailmattermesh",
     *     in="path",
     *     required=true,
