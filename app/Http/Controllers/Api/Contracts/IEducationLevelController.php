...
interface IEducationLevelController
{
    ...
    /**
     * @OA\Get(
     *   path="/api/education-levels/principal",
     *   tags={"Niveles Educativos"},
     *   security={
     *      {"api_key_security": {}},
     *   },
     *   summary="Obtener niveles educativos Padre ",
     *   description="Muestra niveles educativos Exclusivamente padre (que contenga principal_id = null).",
     *   operationId="getOnlyPrincipal",
     *   @OA\Parameter(
     *     name="user_profile_id",
     *     description="Id del perfil de usuario",
     *     in="query",
