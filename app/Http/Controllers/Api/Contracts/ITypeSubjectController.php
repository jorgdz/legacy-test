...
interface ITypeSubjectController {

    /**
     * @OA\Get(
     *   path="/api/type-subjects",
     ...
     *   operationId="getAllTypeSubjects",
     *   @OA\Parameter(
     ...
     *   @OA\JsonContent(
     *      example={
     *          "tm_name" : "required|string|unique:type_subjects,tm_name",
    ...
    /**
     * @OA\Put(
     *   path="/api/type-subjects/{typesubject}",
     *   tags={"Tipos de Materias"},
     *   security={
     *      {"api_key_security": {}},
     *   },
     ...
     *   operationId="updateTypeSubjects",
     *   @OA\Parameter(
     *     name="typesubject",
     *     description="Id del tipo de materia",
     *     in="path",
     ...
     *   @OA\JsonContent(
     *      example={
     *          "tm_name" : "required|string|unique:type_subjects,tm_name,TypeSubject->id",
     *          "tm_acronym" : "required|string|between:2,3",
     *          "tm_order" : "required|integer",
     *          "tm_cobro" : "required|boolean",
     *          "tm_matter_count" : "required|boolean",
     ...
     *   operationId="deleteTypeSubjects",
     *   @OA\Parameter(
     *     name="typesubject",
     *     in="path",
     *     required=true,
