...
class DetailSubjectCurriculum extends Model implements AuditableContract
{
    use HasFactory,UsesTenantConnection,Auditable,SoftDeletes;

    protected $table = 'detail_subject_curriculum';
    ...
    public function matter_mesh () {
        return $this->belongsTo(SubjectCurriculum::class, 'matter_mesh_id','id');
    }
