...
class CreateTypePeriodsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('type_periods', function (Blueprint $table) {
            ...
            $table->bigInteger('tp_min_matter_enrollment')->nullable();
            $table->bigInteger('tp_max_matter_enrollment')->nullable();
            $table->bigInteger('tp_num_fees')->nullable();
            $table->bigInteger('tp_fees_enrollment')->nullable();
