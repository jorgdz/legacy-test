...
Route::get('/catalogs/{catalog:keyword}/children-keywork', [CatalogController::class, 'getChildrenByKeywork'])->middleware(['auth:sanctum', 'permission:catalogs-obtener-catalog']);
