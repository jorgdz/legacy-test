...
Route::put('/config-type-application/{configtypeapplication}', [ConfigTypeApplicationController::class, 'update'])->middleware(['auth:sanctum', 'permission:config-type-application-actualizar-config-tipo-solicitudes']);
Route::delete('/config-type-application/{configtypeapplication}', [ConfigTypeApplicationController::class, 'destroy'])->middleware(['auth:sanctum', 'permission:config-type-application-borrar-config-tipo-solicitudes']);