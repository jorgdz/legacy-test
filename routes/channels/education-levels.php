...
Route::get('/education-levels/principal', [EducationLevelController::class, 'getOnlyPrincipal'])->middleware(['auth:sanctum', /* 'permission:education-levels-obtener-nivel-educativo-principal' */]);
