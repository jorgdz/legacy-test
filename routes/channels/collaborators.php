...
Route::get('/collaborators/{educationlevel}/per-education-level', [CollaboratorController::class, 'getCollaboratorsPerEducationLvl'])->middleware(['auth:sanctum'/* , 'permission:collaborators-obtener-colaborador' */]);
